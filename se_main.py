...
cmd = "python3 se_py/stu_minifier.py > minified_json/se/stu2.json" # < stu.json"
if call(cmd, shell=True) == 0:
	print("stu_minifier")
else:
	print("ABORT ERROR")
...
cmd = "python3 se_py/sub_minifier.py > minified_json/se/sub2.json" # < sub.json"
if call(cmd, shell=True) == 0:
	print("sub_minifier")
else:
	print("ABORT ERROR")
...
cmd = "python3 se_py/csv_maker.py > se.csv "#minified_json/se/sub.json" # < sub.json"
if call(cmd, shell=True) == 0:
	print("sub_minifier")
else:
	print("ABORT ERROR")
